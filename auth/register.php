...
if (isset($_POST['registrasi'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO user (username,password,nama_lengkap,role) VALUES ('$username','$password','$nama_lengkap','user')");
...
<body class="text-slate-700 min-h-screen flex items-center justify-center font-sans antialiased p-4 relative overflow-hidden bg-slate-100">
    ...
    <main class="w-full max-w-md relative z-10 transition-all duration-300">
        ...
        <form action="register.php" method="post"
            ...
            <div class="flex flex-col gap-1.5">
                <label class="text-xs font-bold text-slate-700 uppercase tracking-wider pl-1">Nama Lengkap</label>
                <div class="relative">
